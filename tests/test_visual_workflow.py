        ...
        "infographics": [
            {
                ...
                "layout": "A tall clay ribbon runs down the centre; five small clay robots stand in a column on its left, three on its right, each holding a tiny pennant.",
                "anchor": "# 教程 | 视觉合同",
            ...
            },
            {
                ...
                "layout": "On the left a dozen small clay workers push loaded carts; on the right one large clay machine with a conveyor belt tended by a single worker.",
                "anchor": "中段锚点一",
                "expected_text": ["业务规则", "像素渲染器"],
            ...
            },
            {
                ...
                "layout": "A wide clay road with small cars runs across the upper half; a second road below is broken where a little bridge has collapsed into rubble.",
                "anchor": "中段锚点二",
            ...
            },
            {
                ...
                "layout": "Three small clay houses sit on a fresh foundation slab in the upper left; five identical houses sit on a cracked older slab in the lower right.",
                "anchor": "结尾锚点",
                "expected_text": ["草稿已读回", "上线由人拍板"],
                "facts": ["自动链终点是微信草稿箱"],
            },
        ],
    }
